        ...
        if run_health:
            ...
            if run_parallel:
                ...
                with concurrent.futures.ProcessPoolExecutor(max_workers=5) as health_executor:
                    ...
                    allcause_ve_future = health_executor.submit(visualize_and_export_hia, allcause, ca_shp_path, 'TOTAL', 'ALL CAUSE', output_resolution, conc.boundary, output_dir, f_out, shape_out, verbose=verbose, debug_mode=debug_mode)
